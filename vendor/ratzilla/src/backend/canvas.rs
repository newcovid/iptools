...
pub struct CanvasBackendOptions {
    ...
    /// CSS canvas font used for terminal glyphs.
    font: Option<String>,
}
...
impl CanvasBackendOptions {
    ...
    /// Sets the CSS canvas font used for terminal glyphs.
...
impl CanvasBackend {
    ...
    pub fn new_with_options(options: CanvasBackendOptions) -> Result<Self, Error> {
        ...
        let canvas = Canvas::new(
            ...
            height,
            Color::Black,
            options.font.as_deref().unwrap_or("16px monospace"),
        )?;
